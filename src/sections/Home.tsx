...
function Home() {
    ...
    function getQueryVariable(variable: any): any {
        ...
        <>
            <div>
                <div className='container' style={{overflow: 'auto'}}>
                    <div className='canvas' id='scroll'>
                        {/* all the visual elements of wheel are put in here */}
                    </div>
                <div>
                    <img src="/img/alluminium_bg.png" alt="" id="backgear" className="backgear-img"
                        style={backgroundImgStyle} />
                </div>
                <div id='icon-div'>
                    <button type="button" className="btn" id="btn_more" data-toggle="modal" data-target="#exampleModal1">
                        MORE
                    </button>
                    <button type="button" className="btn" id="btn_about" data-toggle="modal" data-target="#exampleModal2">
                        ABOUT
                    </button>
                    
                    {/* Dropdown list for button "LOCALITY" */}
                    ...
                    <div className="dropdown-menu" aria-labelledby="btn_switch">
                        <a href="/page?city=Durham">
                            <button className="dropdown-item" type="button">Durham</button>
                        </a>
                        <a href="/page?city=Essex">
                            {/* <a href="/climatefutures/page/?city=Essex"></a> */}
                            <button className="dropdown-item" type="button">Essex</button>
                        </a>
                        <a href="/page?city=Newburyport">
                            <button className="dropdown-item" type="button">Newburyport</button>
                        </a>
                        <a href="/page?city=Rockport">
                            <button className="dropdown-item" type="button">Rockport</button>
                        </a>
                        {/* <a href="/page?city=Arlington"> */}
                            <a href="#">
                                <button className="dropdown-item" type="button">Arlington</button>
                                {/* <button className="dropdown-item" type="button" disabled>Arlington</button> */}
                            </a>
                            <a href="/page?city=Trustees">
                                {/* <a href="#"> */}
                                    <button className="dropdown-item" type="button">Trustees</button>
                                </a>
                                <a href="/page?city=Salem">
                                    <button className="dropdown-item" type="button">Salem</button>
                                </a>
                                <a href="/page?city=Saugus">
                                    <button className="dropdown-item" type="button">Saugus</button>
                                </a>
                                <a href="/page?city=Ipswich">
                                    <button className="dropdown-item" type="button">Ipswich</button>
                                </a>
                                <a href="/page?city=Salisbury">
                                    <button className="dropdown-item" type="button">Salisbury</button>
                                </a>
                                <a href="/page?city=Lynn">
                                    <button className="dropdown-item" type="button">Lynn</button>
                                </a>
